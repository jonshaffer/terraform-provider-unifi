![Acceptance Tests](https://github.com/jonshaffer/terraform-provider-unifi/workflows/Acceptance%20Tests/badge.svg?event=push)
...
Functionality first needs to be added to the [go-unifi](https://github.com/jonshaffer/go-unifi) SDK.
...
As of version [v0.34](https://github.com/jonshaffer/terraform-provider-unifi/releases/tag/v0.34.0), this provider only supports version 6 of the Unifi controller software. If you need v5 support, you can pin an older version of the provider.
